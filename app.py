...
# Create table if not exists (Cloud pe db new ho sakta hai)
cursor.execute("""
...
with st.form("kpi_form", clear_on_submit=True):
    ...
    with k1:
        kpi1 = st.number_input("KPI 1 (1–100)", min_value=1, max_value=100, value=1, step=1, help="Minimum 1, Maximum 100")
    with k2:
        kpi2 = st.number_input("KPI 2 (1–100)", min_value=1, max_value=100, value=1, step=1, help="Minimum 1, Maximum 100")
    with k3:
        kpi3 = st.number_input("KPI 3 (1–100)", min_value=1, max_value=100, value=1, step=1, help="Minimum 1, Maximum 100")
    with k4:
        kpi4 = st.number_input("KPI 4 (1–100)", min_value=1, max_value=100, value=1, step=1, help="Minimum 1, Maximum 100")
...
if submitted:
    ...
    if emp == "":
        ...
        created_at = datetime.now().isoformat(sep=" ", timespec="seconds")  # uniform format
...
# Date filter SQL me (pandas datetime error avoid)
